...
<template>
    <div class= 'ConteinerInput' >
        <input class="inputObj" :type=tipo :placeholder=customText :style="{'width':containerMaxWidth, 'min-width':containerMinWidth, 'margin-left':ml}" :value="inputValue" @input="updateInputValue"  onfocus="(this.type='date')"/>
    </div>
</template>
